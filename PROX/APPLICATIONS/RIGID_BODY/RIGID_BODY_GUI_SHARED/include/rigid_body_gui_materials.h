#ifndef RIGID_BODY_GUI_MATERIALS_H
#define RIGID_BODY_GUI_MATERIALS_H
...
namespace rigid_body
{
  namespace gui
  {
                                                       ...
                                                       )
    {
      ...
      material.m_use_texture  = util::to_value<bool>( params.get_value( material_name + "_use_texture" ,   "true") );
