#ifndef RIGID_BODY_GUI_DRAW_SSAO_H
#define RIGID_BODY_GUI_DRAW_SSAO_H
  ...
  namespace gui
  {
                                    ...
                                    )
    {
      ...
      for(;object!=end;++object)
      {
        ...
        program.set_uniform( "material_map", 0 ); // Solid sampler should use texture unit 0
