...
namespace geometry
{
  namespace detail
  {
                                         ...
                                         )
    {
      ...
      assert( fabs( 1 - inner_prod(A0,A0) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      assert( fabs( 1 - inner_prod(A1,A1) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      assert( fabs( 1 - inner_prod(A2,A2) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      assert( fabs( inner_prod(A0,A1) ) < std::numeric_limits<T>::epsilon()*10             || !"compute_obb_obb_sat_axes(): logic error");
      assert( fabs( inner_prod(A0,A2) ) < std::numeric_limits<T>::epsilon()*10             || !"compute_obb_obb_sat_axes(): logic error");
      assert( fabs( inner_prod(A1,A2) ) < std::numeric_limits<T>::epsilon()*10             || !"compute_obb_obb_sat_axes(): logic error");

      V const B0  = R_b.get_column_copy(0);
      V const B1  = R_b.get_column_copy(1);
      V const B2  = R_b.get_column_copy(2);

      assert( fabs( 1 - inner_prod(B0,B0) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      assert( fabs( 1 - inner_prod(B1,B1) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      assert( fabs( 1 - inner_prod(B2,B2) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      assert( fabs( inner_prod(B0,B1) ) < std::numeric_limits<T>::epsilon()*10             || !"compute_obb_obb_sat_axes(): logic error");
      assert( fabs( inner_prod(B0,B2) ) < std::numeric_limits<T>::epsilon()*10             || !"compute_obb_obb_sat_axes(): logic error");
      assert( fabs( inner_prod(B1,B2) ) < std::numeric_limits<T>::epsilon()*10             || !"compute_obb_obb_sat_axes(): logic error");
      ...
      assert( fabs( 1 - inner_prod(axes[0],axes[0]) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      ...
      assert( fabs( 1 - inner_prod(axes[1],axes[1]) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      ...
      assert( fabs( 1 - inner_prod(axes[2],axes[2]) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      ...
      assert( fabs( 1 - inner_prod(axes[3],axes[3]) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      ...
      assert( fabs( 1 - inner_prod(axes[4],axes[4]) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      ...
      assert( fabs( 1 - inner_prod(axes[5],axes[5]) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      ...
      assert( fabs( 1 - inner_prod(axes[6],axes[6]) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      ...
      assert( fabs( 1 - inner_prod(axes[7],axes[7]) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      ...
      assert( fabs( 1 - inner_prod(axes[8],axes[8]) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      ...
      assert( fabs( 1 - inner_prod(axes[9],axes[9]) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      ...
      assert( fabs( 1 - inner_prod(axes[10],axes[10]) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      ...
      assert( fabs( 1 - inner_prod(axes[11],axes[11]) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      ...
      assert( fabs( 1 - inner_prod(axes[12],axes[12]) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      ...
      assert( fabs( 1 - inner_prod(axes[13],axes[13]) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
      ...
      assert( fabs( 1 - inner_prod(axes[14],axes[14]) ) < std::numeric_limits<T>::epsilon()*10 || !"compute_obb_obb_sat_axes(): logic error");
    }
