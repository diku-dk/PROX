...
{
  util::FolderLocator f1("/Users/kenny/Documents/PROX_TRUNK/bin/resources/", "objs");
  util::FolderLocator f2("/Users/kenny/Documents/PROX_TRUNK/bin/resources", "objs");
  util::FolderLocator f3("/Users/kenny/Documents/PROX_TRUNK/bin/resources/", "/objs");
  util::FolderLocator f4("/Users/kenny/Documents/PROX_TRUNK/bin/resources/objs/");
  util::FolderLocator f5("/Users/kenny/Documents/PROX_TRUNK/bin/resources/objs");

  util::FolderLocator f6("", "objs");
  util::FolderLocator f7("/Users/kenny/Documents/PROX_TRUNK/bin", "objs");
  util::FolderLocator f8("/Users/kenny/Documents/PROX_TRUNK/bin/resources/objs/", "bunny.obj");
