...
BOOST_AUTO_TEST_CASE(block_test)
{
  ...
  // test general block add and sub
    ...
    BOOST_CHECK(b2(2, 0) == 0.0f && b2(2, 1) == 0.0f && b2(2, 2) == 0.0f && b2(2, 3) == 0.0f && b2(2, 4) == 0.0f
                && b2(2, 5) == 0.0f);
    BOOST_CHECK(b2(3, 0) == 0.0f && b2(3, 1) == 0.0f && b2(3, 2) == 0.0f && b2(3, 2) == 0.0f && b2(3, 3) == 0.0f
                && b2(3, 4) == 0.0f);
    sub(b2, b_copy, b2);
    BOOST_CHECK(b2 == b);
  // test block += and -=
    sub(b, b2);
    BOOST_CHECK(b2(0, 0) == 0.0f && b2(0, 1) == 0.0f && b2(0, 2) == 0.0f && b2(0, 3) == 0.0f && b2(0, 4) == 0.0f
                && b2(0, 5) == 0.0f);
    BOOST_CHECK(b2(1, 0) == 0.0f && b2(1, 1) == 0.0f && b2(1, 2) == 0.0f && b2(1, 3) == 0.0f && b2(1, 4) == 0.0f
                && b2(1, 5) == 0.0f);
    BOOST_CHECK(b2(2, 0) == 0.0f && b2(2, 1) == 0.0f && b2(2, 2) == 0.0f && b2(2, 3) == 0.0f && b2(2, 4) == 0.0f
                && b2(2, 5) == 0.0f);
    BOOST_CHECK(b2(3, 0) == 0.0f && b2(3, 1) == 0.0f && b2(3, 2) == 0.0f && b2(3, 2) == 0.0f && b2(3, 3) == 0.0f
  ...
  //div
    ...
    div(2.0f, A, B);
    div(2.0f, A);
    BOOST_CHECK(A(0, 0) == 0.5f);
    BOOST_CHECK(A(0, 1) == 1.0f);
    BOOST_CHECK(A(0, 2) == 1.5f);
    BOOST_CHECK(A(1, 0) == 2.0f);
    BOOST_CHECK(A(1, 1) == 2.5f);
    BOOST_CHECK(A(1, 2) == 3.0f);
    BOOST_CHECK(A(2, 0) == 3.5f);
    BOOST_CHECK(A(2, 1) == 4.0f);
    BOOST_CHECK(A(2, 2) == 4.5f);
    BOOST_CHECK(B(0, 0) == 0.5f);
    BOOST_CHECK(B(0, 1) == 1.0f);
    BOOST_CHECK(B(0, 2) == 1.5f);
    BOOST_CHECK(B(1, 0) == 2.0f);
    BOOST_CHECK(B(1, 1) == 2.5f);
    BOOST_CHECK(B(1, 2) == 3.0f);
    BOOST_CHECK(B(2, 0) == 3.5f);
    BOOST_CHECK(B(2, 1) == 4.0f);
    BOOST_CHECK(B(2, 2) == 4.5f);
