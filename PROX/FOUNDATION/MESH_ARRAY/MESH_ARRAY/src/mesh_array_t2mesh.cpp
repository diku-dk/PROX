...
T2Mesh::~T2Mesh() { this->clear(); }

T2Mesh::T2Mesh(T2Mesh const& o) { (*this) = o; }
...
size_t T2Mesh::vertex_size() const { return this->m_next_free_vertex; }

size_t T2Mesh::edge_size() const { return this->m_next_free_edge; }

size_t T2Mesh::vertex_capacity() const { return this->m_vertices.size(); }

size_t T2Mesh::edge_capacity() const { return this->m_edges.size(); }
