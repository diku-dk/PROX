...
TriangleCirculator<T3Mesh>::TriangleCirculator(TriangleCirculator const& o) { (*this) = o; }
...
Triangle const* TriangleCirculator<T3Mesh>::operator->() const { return &(this->operator*()); }
...
bool TriangleCirculator<T3Mesh>::operator()() const { return this->m_cur < this->m_end; }
