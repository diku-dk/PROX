      ...
      //--- Fill in triangle face data
        {
            ...
            FORALLfacets
            {
                ...
                if (facet->toporient) { mesh.push_triangle(idx[2], idx[1], idx[0]); }
...
void make_convex(std::vector< typename MT::vector3_type> const& vertices, T3Mesh& mesh,
                 VertexAttribute<typename MT::real_type, T3Mesh>& X, VertexAttribute<typename MT::real_type, T3Mesh>& Y,
...
template void make_convex<MTf>(std::vector<MTf::vector3_type> const& vertices, T3Mesh& mesh,
                               VertexAttribute<MTf::real_type, T3Mesh>& X, VertexAttribute<MTf::real_type, T3Mesh>& Y,
                               VertexAttribute<MTf::real_type, T3Mesh>& Z);

template void make_convex<MTd>(std::vector< MTd::vector3_type> const& vertices, T3Mesh& mesh,
                               VertexAttribute< MTd::real_type, T3Mesh>& X, VertexAttribute< MTd::real_type, T3Mesh>& Y,
