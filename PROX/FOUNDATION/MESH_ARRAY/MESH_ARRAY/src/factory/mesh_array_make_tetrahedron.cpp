...
template <typename T>
void make_tetrahedron(EigenVector3<T> const& p0, EigenVector3<T> const& p1, EigenVector3<T> const& p2,
                      EigenVector3<T> const& p3, T3Mesh& mesh, VertexAttribute<T, T3Mesh>& X,
