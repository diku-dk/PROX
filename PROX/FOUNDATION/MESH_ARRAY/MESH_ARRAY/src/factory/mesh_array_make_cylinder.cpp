...
template <typename T>
void make_cylinder(T const& radius, T const& height, size_t const& slices, T3Mesh& mesh, VertexAttribute<T, T3Mesh>& X,
...
template void make_cylinder<float>(float const& radius, float const& height, size_t const& slices, T3Mesh& mesh,
                                   VertexAttribute<float, T3Mesh>& X, VertexAttribute<float, T3Mesh>& Y,
                                   VertexAttribute<float, T3Mesh>& Z);

template void make_cylinder<double>(double const& radius, double const& height, size_t const& slices, T3Mesh& mesh,
