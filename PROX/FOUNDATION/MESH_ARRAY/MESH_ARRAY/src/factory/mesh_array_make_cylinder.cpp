...
namespace mesh_array
{
                    ...
                    )
  {
    ...
    template void make_cylinder<MTf>(MTf::real_type const& radius, MTf::real_type const& height, size_t const& slices,
    ...
    template void make_cylinder<MTd>(MTd::real_type const& radius, MTd::real_type const& height, size_t const& slices,
