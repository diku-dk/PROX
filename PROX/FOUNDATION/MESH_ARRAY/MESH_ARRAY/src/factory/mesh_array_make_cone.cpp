...
namespace mesh_array
{
                 ...
                 )
  {
    ...
    template void make_cone<float>(float const& radius, float const& height, size_t const& slices,
                                 T3Mesh& mesh, VertexAttribute<float, T3Mesh>& X,
                                 VertexAttribute<float, T3Mesh>& Y,
                                 VertexAttribute<float, T3Mesh>& Z);

    template void make_cone<double>(double const& radius, double const& height, size_t const& slices,
