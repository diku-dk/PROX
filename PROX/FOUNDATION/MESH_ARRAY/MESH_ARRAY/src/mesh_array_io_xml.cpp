...
template <typename T>
void read_xml(std::string const& filename, T4Mesh& mesh, VertexAttribute<T, T4Mesh>& X, VertexAttribute<T, T4Mesh>& Y,
              VertexAttribute<T, T4Mesh>& Z)
{
    ...
    for (size_t idx = 0u; idx < cntV; ++idx) mesh.push_vertex();
...
template void read_xml<float>(std::string const& filename, T4Mesh& mesh, VertexAttribute<float, T4Mesh>& X,
                              VertexAttribute<float, T4Mesh>& Y, VertexAttribute<float, T4Mesh>& Z);

template void read_xml<double>(std::string const& filename, T4Mesh& mesh, VertexAttribute<double, T4Mesh>& X,
                               VertexAttribute<double, T4Mesh>& Y, VertexAttribute<double, T4Mesh>& Z);

template <typename T>
void write_xml(std::string const& filename, T4Mesh const& mesh, VertexAttribute<T, T4Mesh> const& X,
...
template void write_xml<float>(std::string const& filename, T4Mesh const& mesh, VertexAttribute<float, T4Mesh> const& X,
                               VertexAttribute<float, T4Mesh> const& Y, VertexAttribute<float, T4Mesh> const& Z);

template void write_xml<double>(std::string const& filename, T4Mesh const& mesh,
