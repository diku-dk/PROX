...
VertexRing<T3Mesh>::~VertexRing() { this->release(); }

VertexRing<T3Mesh>::VertexRing(T3Mesh const& m) { this->bind(m); }

VertexRing<T3Mesh>::VertexRing(VertexRing<T3Mesh> const& o) { (*this) = o; }
...
T3Mesh const* VertexRing<T3Mesh>::mesh() const { return this->m_mesh; }
...
std::vector< size_t > const& VertexRing<T3Mesh>::offset() const { return this->m_offset; }

std::vector< std::pair<size_t, size_t > > const& VertexRing<T3Mesh>::V2T() const { return this->m_V2T; }
