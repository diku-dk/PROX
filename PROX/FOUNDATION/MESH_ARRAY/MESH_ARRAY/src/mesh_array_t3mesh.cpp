...
T3Mesh::~T3Mesh() { this->clear(); }

T3Mesh::T3Mesh(T3Mesh const& o) { (*this) = o; }
...
size_t T3Mesh::vertex_size() const { return this->m_next_free_vertex; }

size_t T3Mesh::triangle_size() const { return this->m_next_free_triangle; }

size_t T3Mesh::vertex_capacity() const { return this->m_vertices.size(); }

size_t T3Mesh::triangle_capacity() const { return this->m_triangles.size(); }
