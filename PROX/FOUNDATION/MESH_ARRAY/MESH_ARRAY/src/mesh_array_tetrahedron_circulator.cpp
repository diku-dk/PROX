...
TetrahedronCirculator<T4Mesh>::TetrahedronCirculator(TetrahedronCirculator const& o) { (*this) = o; }
...
Tetrahedron const* TetrahedronCirculator<T4Mesh>::operator->() const { return &(this->operator*()); }

Tetrahedron* TetrahedronCirculator<T4Mesh>::operator->() { return &(this->operator*()); }
...
bool TetrahedronCirculator<T4Mesh>::operator()() const { return this->m_cur < this->m_end; }
