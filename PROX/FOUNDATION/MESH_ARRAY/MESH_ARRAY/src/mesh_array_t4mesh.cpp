...
T4Mesh::~T4Mesh() { this->clear(); }

T4Mesh::T4Mesh(T4Mesh const& o) { (*this) = o; }
...
size_t T4Mesh::vertex_size() const { return this->m_next_free_vertex; }

size_t T4Mesh::tetrahedron_size() const { return this->m_next_free_tetrahedron; }

size_t T4Mesh::vertex_capacity() const { return this->m_vertices.size(); }

size_t T4Mesh::tetrahedron_capacity() const { return this->m_tetrahedra.size(); }
