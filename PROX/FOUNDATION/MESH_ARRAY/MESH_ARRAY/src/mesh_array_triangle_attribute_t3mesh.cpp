...
template <typename T> TriangleAttribute<T, T3Mesh>::~TriangleAttribute() { this->release(); }

template <typename T> TriangleAttribute<T, T3Mesh>::TriangleAttribute(T3Mesh const& m) { this->bind(m); }

template <typename T> TriangleAttribute<T, T3Mesh>::TriangleAttribute(TriangleAttribute<T, T3Mesh> const& o)
{
    (*this) = o;
}
...
template <typename T> T3Mesh const* TriangleAttribute<T, T3Mesh>::mesh() const { return this->m_mesh; }

template <typename T> void TriangleAttribute<T, T3Mesh>::bind(T3Mesh const& m)
{
    this->release();
...
template <typename T> void TriangleAttribute<T, T3Mesh>::release()
{
    this->m_mesh = nullptr;
    this->m_data.clear();
}

template <typename T> size_t TriangleAttribute<T, T3Mesh>::size() const { return this->m_data.size(); }
