...
#include <mesh_array_make_t3mesh.h>
#include <mesh_array_neighborhoods.h>

#include <mesh_array_compute_distance_map.h>
#include <mesh_array_compute_surface_map.h>
#include <mesh_array_compute_vertex_normals.h>
