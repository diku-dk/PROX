...
namespace mesh_array
{
  ...
  inline void concatenation(
      T3Mesh const & A
      , VertexAttribute<T,T3Mesh> const & Ax
      , VertexAttribute<T,T3Mesh> const & Ay
      , VertexAttribute<T,T3Mesh> const & Az
      , T3Mesh const & B
      , VertexAttribute<T,T3Mesh> const & Bx
      , VertexAttribute<T,T3Mesh> const & By
      , VertexAttribute<T,T3Mesh> const & Bz
      , T3Mesh & C
      , VertexAttribute<T,T3Mesh> & Cx
      , VertexAttribute<T,T3Mesh> & Cy
      , VertexAttribute<T,T3Mesh> & Cz
      )
  {
      ...
      )
  {
      ...
      VertexAttribute<T,T3Mesh> const Bx = Cx;
      VertexAttribute<T,T3Mesh> const By = Cy;
      VertexAttribute<T,T3Mesh> const Bz = Cz;

      concatenation<T>(A,Ax,Ay,Az,B,Bx,By,Bz,C,Cx,Cy,Cz);
  }
