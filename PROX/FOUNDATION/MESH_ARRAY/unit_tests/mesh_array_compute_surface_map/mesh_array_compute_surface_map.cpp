...
BOOST_AUTO_TEST_CASE(mesh_array_compute_surface_map_sphere)
{
    ...
    for (size_t idx = 0u; idx < mesh.tetrahedron_size(); ++idx)
    {
        ...
        std::cout << "\t" << distance_i << " " << distance_j << " " << distance_k << " " << distance_m << " "
                  << std::endl;

        std::cout << "\t" << i_on_surface << " " << j_on_surface << " " << k_on_surface << " " << m_on_surface << " "
                  << std::endl;

        std::cout << "\t" << opposite_i_on_surface << " " << opposite_j_on_surface << " " << opposite_k_on_surface
                  << " " << opposite_m_on_surface << " " << std::endl;
    }
}
