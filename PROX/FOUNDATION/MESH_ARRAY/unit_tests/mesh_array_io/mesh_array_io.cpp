...
void test_correct_tetgen(mesh_array::T3Mesh const& M, mesh_array::t3_vertex_float_attribute const& X,
                         mesh_array::t3_vertex_float_attribute const& Y, mesh_array::t3_vertex_float_attribute const& Z)
{
...
void test_correct_tetgen(mesh_array::T4Mesh const& M, mesh_array::t4_vertex_float_attribute const& X,
                         mesh_array::t4_vertex_float_attribute const& Y, mesh_array::t4_vertex_float_attribute const& Z)
{
    BOOST_CHECK_EQUAL(X.size(), 8);
    BOOST_CHECK_EQUAL(Y.size(), 8);
    BOOST_CHECK_EQUAL(Z.size(), 8);
...
void test_correct_obj(mesh_array::T3Mesh const& M, mesh_array::t3_vertex_float_attribute const& X,
                      mesh_array::t3_vertex_float_attribute const& Y, mesh_array::t3_vertex_float_attribute const& Z)
{
    BOOST_CHECK_EQUAL(X.size(), 8);
    BOOST_CHECK_EQUAL(Y.size(), 8);
