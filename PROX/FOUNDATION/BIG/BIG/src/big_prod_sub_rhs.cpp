...
{
template <typename T>
void prod_sub_rhs(boost::numeric::ublas::compressed_matrix<T> const& A, boost::numeric::ublas::vector<T> const& x,
                  boost::numeric::ublas::vector<T> const& b, boost::numeric::ublas::vector<T>& y)
{
    ...
    if (y.size() != b.size()) y.resize(b.size(), false);
...
template void prod_sub_rhs<float>(boost::numeric::ublas::compressed_matrix<float> const& A,
                                  boost::numeric::ublas::vector<float> const& x,
                                  boost::numeric::ublas::vector<float> const& b,
                                  boost::numeric::ublas::vector<float>& y);

template void prod_sub_rhs<double>(boost::numeric::ublas::compressed_matrix<double> const& A,
