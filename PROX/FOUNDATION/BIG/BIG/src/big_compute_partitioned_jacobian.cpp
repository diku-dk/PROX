...
template <typename T>
void compute_partitioned_jacobian(ublas::compressed_matrix<T> const& A, ublas::vector<size_t> const& bitmask,
                                  ublas::vector<size_t> const& old2new, size_t const& cnt_active,
                                  size_t const& cnt_inactive, ublas::compressed_matrix<T>& A_aa,
...
template void compute_partitioned_jacobian<float>(ublas::compressed_matrix<float> const& A,
                                                  ublas::vector<size_t> const& bitmask,
                                                  ublas::vector<size_t> const& old2new, size_t const& cnt_active,
                                                  size_t const& cnt_inactive, ublas::compressed_matrix<float>& A_aa,
                                                  ublas::compressed_matrix<float>& A_ab);

template void compute_partitioned_jacobian<double>(ublas::compressed_matrix<double> const& A,
                                                   ublas::vector<size_t> const& bitmask,
                                                   ublas::vector<size_t> const& old2new, size_t const& cnt_active,
                                                   size_t const& cnt_inactive, ublas::compressed_matrix<double>& A_aa,
