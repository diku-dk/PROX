...
{
template <typename T>
void prod_add_rhs(boost::numeric::ublas::compressed_matrix<T> const& A, boost::numeric::ublas::vector<T> const& x,
...
template void prod_add_rhs<float>(boost::numeric::ublas::compressed_matrix<float> const& A,
                                  boost::numeric::ublas::vector<float> const& x,
                                  boost::numeric::ublas::vector<float> const& b,
                                  boost::numeric::ublas::vector<float>& y);

template void prod_add_rhs<double>(boost::numeric::ublas::compressed_matrix<double> const& A,
