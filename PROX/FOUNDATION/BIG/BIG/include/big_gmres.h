...
namespace big
{
                    ...
                    )
  {
    ...
    vector_type g( inner+1u );           // Allocate space for the right hand side vector of the least squares sub problem.
                    ...
                    )
  {
    ...
    typename vector_type::value_type tolerance               = 0.0;
    typename vector_type::value_type relative_residual_error = 0.0;
