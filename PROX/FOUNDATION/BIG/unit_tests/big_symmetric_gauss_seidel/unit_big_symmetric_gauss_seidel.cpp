...
BOOST_AUTO_TEST_SUITE(big_boost_preconditioners_symmetric_gauss_seidel);
...
BOOST_AUTO_TEST_CASE(logic_and_valid_arguments_testing)
{
...

    {
        matrix_type A;
        vector_type b, x;
        BOOST_CHECK_THROW(big::symmetric_gauss_seidel(A, x, b), std::invalid_argument);
    }
    {
        matrix_type A;
        vector_type b, x;
    ...
    }
    {
        ...
        BOOST_CHECK_NO_THROW(big::symmetric_gauss_seidel(A, x, b));
    }
    {
        matrix_type A;
        vector_type b, x;
