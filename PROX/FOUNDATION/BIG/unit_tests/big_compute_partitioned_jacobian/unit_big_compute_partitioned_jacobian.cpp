...
BOOST_AUTO_TEST_CASE(test_case1)
{
    ...
    big::compute_partitioned_jacobian(A, bitmask, old2new, 4, 6, A_aa, A_ab);
...
BOOST_AUTO_TEST_CASE(test_case2)
{
    ...
    big::compute_partitioned_jacobian(A, bitmask, old2new, 10, 0, A_aa, A_ab);
...
BOOST_AUTO_TEST_CASE(test_case3)
{
    ...
    big::compute_partitioned_jacobian(A, bitmask, old2new, 0, 10, A_aa, A_ab);
