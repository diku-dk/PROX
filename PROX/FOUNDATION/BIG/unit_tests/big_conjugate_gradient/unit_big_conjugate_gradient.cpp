...
void test(matrix_type const& A, vector_type& x, vector_type const& b, vector_type const& y)
{
    ...
    big::conjugate_gradient(A, x, b, max_iterations, epsilon, iterations);
...
BOOST_AUTO_TEST_SUITE(big_conjugate_gradient);
...
BOOST_AUTO_TEST_CASE(logic_and_valid_arguments_testing)
{
...

    {
        matrix_type A;
        vector_type x, b;
        BOOST_CHECK_THROW(big::conjugate_gradient(A, x, b), std::invalid_argument);
    }
    {
        matrix_type A;
        vector_type x, b;
    ...
    }
    {
        ...
        BOOST_CHECK_NO_THROW(big::conjugate_gradient(A, x, b));
    }
    {
        matrix_type A;
        vector_type x, b;
