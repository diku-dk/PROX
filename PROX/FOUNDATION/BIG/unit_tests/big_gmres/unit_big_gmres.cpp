...
BOOST_AUTO_TEST_SUITE(big_gmres);
...
BOOST_AUTO_TEST_CASE(test_case_1)
{
    ...
    real_type tol = 5.0;
    {
        ...
        size_t status = 0;
        big::gmres(A, x, b, M, R, eps, relative_residual_error, used_inner_iterations, used_outer_iterations, status);
