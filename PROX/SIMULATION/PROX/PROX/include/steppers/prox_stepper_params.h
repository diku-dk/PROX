...
public:
    ...
    void set_stepper(stepper_type const& value) { this->m_stepper = value; }

    void set_pre_stabilization(bool const& value) { this->m_pre_stabilization = value; }

    void set_post_stabilization(bool const& value) { this->m_post_stabilization = value; }

    void set_contact_reduction(bool const& value) { this->m_contact_reduction = value; }

    void set_bounce_on(bool const& value) { this->m_bounce_on = value; }

    StepperParams()
        : m_stepper(semi_implicit)
        , m_min_gap(0.001f)
        , m_max_gap(0.01f)
        , m_gap_reduction(0.5f)
