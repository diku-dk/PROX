...
template < typename T> class MyObject : public broad::Object<T>
{
protected:
    T m_mx;
    T m_my;
...
inline bool exist_unique_overlap(object_type const& A, object_type const& B, overlap_container const& O)
{
    ...
    for (auto o = O.begin(); o != O.end(); ++o)
    {
        ...
        if (o->first == a && o->second == b) count++;
        if (o->first == b && o->second == a) count++;
    }
    return count == 1u;
}
...
BOOST_AUTO_TEST_CASE(no_overlap_test)
{
    ...
    O1.set_box(-10.0f, -1.0f, -1.0f, -9.0f, 1.0f, 1.0f);
    O2.set_box(-8.0f, -1.0f, -1.0f, -7.0f, 1.0f, 1.0f);
    O3.set_box(-6.0f, -1.0f, -1.0f, -5.0f, 1.0f, 1.0f);
...
BOOST_AUTO_TEST_CASE(large_aspect_ratio_test)
{
    ...
    O1.set_box(-10.0f, -1.0f, -1.0f, 10.0f, 1.0f, 1.0f);
    O2.set_box(-1.0f, -10.0f, -1.0f, 1.0f, 10.0f, 1.0f);

    O3.set_box(10.0f, 10.0f, -1.0f, 11.0f, 11.0f, 1.0f);
...
BOOST_AUTO_TEST_CASE(touching_contact_test)
{
    ...
    O1.set_box(-1.0f, -1.0f, -1.0f, 1.0f, 1.0f, 1.0f);
    O2.set_box(1.0f, -1.0f, -1.0f, 2.0f, 1.0f, 1.0f);

    O3.set_box(-1.0f, 1.0f, -1.0f, 1.0f, 2.0f, 1.0f);

    O4.set_box(-1.0f, -1.0f, 1.0f, 1.0f, 1.0f, 2.0f);
...
BOOST_AUTO_TEST_CASE(inclusion_test)
{
    ...
    O1.set_box(-1.0f, -1.0f, -1.0f, 1.0f, 1.0f, 1.0f);
    O2.set_box(-2.0f, -2.0f, -2.0f, 2.0f, 2.0f, 2.0f);

    O3.set_box(5.0f, 5.0f, -1.0f, 6.0f, 6.0f, 1.0f);
