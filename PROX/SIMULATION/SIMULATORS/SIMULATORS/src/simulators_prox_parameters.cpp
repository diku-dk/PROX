  ...
  void ProxEngine::set_parameter(std::string const & name, std::string const & value )
  {
    ...
    else if (name == PARAM_NORMAL_SOLVER)
    {
      ...
      else
      {
        ...
        logging << "ProxEngine::set_parameter(): unknown normal sub solver value = " << value << util::Log::newline();
      }
    }
    else if (name == PARAM_FRICTION_SOLVER)
    {
      ...
      else
      {
        ...
        logging << "ProxEngine::set_parameter(): unknown friction sub solver value = " << value << util::Log::newline();
      }
    }
    ...
    else if (name == PARAM_R_FACTOR)
    {
      ...
      else
      {
        ...
        logging << "ProxEngine::set_parameter(): unknown r-factor strategy value = " << value << util::Log::newline();
      }
    }
