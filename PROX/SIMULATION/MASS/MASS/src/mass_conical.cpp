...
template Properties<float> compute_conical_solid<float>(float const& density, float const& bottom_radius,
                                                        float const& top_radius, float const& height);

template Properties<double> compute_conical_solid<double>(double const& density, double const& bottom_radius,
                                                          double const& top_radius, double const& height);
