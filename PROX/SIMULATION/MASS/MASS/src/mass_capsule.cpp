...
template Properties<float> compute_capsule<float>(float const& density, float const& radius, float const& half_height);

template Properties<double> compute_capsule<double>(double const& density, double const& radius,
