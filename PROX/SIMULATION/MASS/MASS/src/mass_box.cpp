...
template <typename T>
Properties<T> compute_box(T const& density, T const& half_width, T const& half_height, T const& half_depth)
{
...
template Properties<float> compute_box<float>(float const& density, float const& half_width, float const& half_height,
                                              float const& half_depth);

template Properties<double> compute_box<double>(double const& density, double const& half_width,
                                                double const& half_height, double const& half_depth);
