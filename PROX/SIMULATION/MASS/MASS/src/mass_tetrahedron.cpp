...
template <typename T>
Properties<T> compute_tetrahedron(T const& density, T const& x1, T const& y1, T const& z1, T const& x2, T const& y2,
...
template Properties<float> compute_tetrahedron<float>(float const& density, float const& x1, float const& y1,
                                                      float const& z1, float const& x2, float const& y2,
                                                      float const& z2, float const& x3, float const& y3,
                                                      float const& z3, float const& x4, float const& y4,
                                                      float const& z4);

template Properties<double> compute_tetrahedron<double>(double const& density, double const& x1, double const& y1,
                                                        double const& z1, double const& x2, double const& y2,
                                                        double const& z2, double const& x3, double const& y3,
                                                        double const& z3, double const& x4, double const& y4,
                                                        double const& z4);
