...
template Properties<float> translate_to_model_frame(float const& dx, float const& dy, float const& dz,
                                                    Properties<float> const& Ibody);

template Properties<double> translate_to_model_frame(double const& dx, double const& dy, double const& dz,
                                                     Properties<double> const& Ibody);

template Properties<float> translate_to_body_frame(Properties<float> const& Imodel);

template Properties<double> translate_to_body_frame(Properties<double> const& Imodel);
