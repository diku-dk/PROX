            ...
            T const& R21, T const& R22, T& Ixx, T& Iyy, T& Izz, T& Ixy, T& Ixz, T& Iyz)
{
    ...
    Ixx = (R00 * R00 * Jxx + R01 * R01 * Jyy + R02 * R02 * Jzz)
        + two * (R00 * R01 * Jxy + R00 * R02 * Jxz + R01 * R02 * Jyz);
    Iyy = (R10 * R10 * Jxx + R11 * R11 * Jyy + R12 * R12 * Jzz)
        + two * (R10 * R11 * Jxy + R10 * R12 * Jxz + R11 * R12 * Jyz);
    Izz = (R20 * R20 * Jxx + R21 * R21 * Jyy + R22 * R22 * Jzz)
        + two * (R20 * R21 * Jxy + R20 * R22 * Jxz + R21 * R22 * Jyz);

    Ixy = (R10 * R00 * Jxx + R11 * R01 * Jyy + R12 * R02 * Jzz) + (R10 * R01 + R11 * R00) * Jxy
        + (R12 * R01 + R11 * R02) * Jyz + (R12 * R00 + R10 * R02) * Jxz;
    Ixz = (R20 * R00 * Jxx + R21 * R01 * Jyy + R22 * R02 * Jzz) + (R20 * R01 + R21 * R00) * Jxy
        + (R22 * R00 + R20 * R02) * Jxz + (R21 * R02 + R22 * R01) * Jyz;
    Iyz = (R10 * R20 * Jxx + R11 * R21 * Jyy + R12 * R22 * Jzz) + (R10 * R21 + R11 * R20) * Jxy
        + (R10 * R22 + R12 * R20) * Jxz + (R11 * R22 + R12 * R21) * Jyz;
}
...
template Properties<float> rotate<float>(float const& qs, float const& qx, float const& qy, float const& qz,
                                         Properties<float> const& I);

template Properties<double> rotate<double>(double const& qs, double const& qx, double const& qy, double const& qz,
                                           Properties<double> const& I);

template Properties<float> rotate_to_body_frame(Properties<float> const& Imodel);

template Properties<double> rotate_to_body_frame(Properties<double> const& Imodel);
