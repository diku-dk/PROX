...
namespace kdop
{
  namespace details
  {
     ...
     * Convenience wrapper....
     *
     * To keep traversal more generic it calls the overloaded "contacts_shape_tetrahedron" function.
     * One can simply add more overloads to extend with support for more geometry types.
     *
     *
