...
{
  //--------------------------------------------------------------------------------
void ChannelStorage::clear() { m_channels.clear(); }
...
size_t ChannelStorage::create_key(size_t const& channel_idx, float const& time)
{
  ...
  //--------------------------------------------------------------------------------
void ChannelStorage::set_key_position(size_t const& channel_idx, size_t const& key_idx, float const& x, float const& y,
                                      float const& z)
{
  ...
  //--------------------------------------------------------------------------------
void ChannelStorage::set_key_orientation(size_t const& channel_idx, size_t const& key_idx, float const& qs,
                                         float const& qx, float const& qy, float const& qz)
{
  ...
  //--------------------------------------------------------------------------------
size_t ChannelStorage::get_number_of_channels() const { return m_channels.size(); }

  //--------------------------------------------------------------------------------
size_t ChannelStorage::get_channel_id(size_t const& channel_index) const { return m_channels[channel_index].m_id; }
...
float ChannelStorage::get_key_time(size_t const& channel_index, size_t const& key_index) const
{
  ...
  //--------------------------------------------------------------------------------
void ChannelStorage::get_key_position(size_t const& channel_index, size_t const& key_index, float& x, float& y,
                                      float& z) const
{
  ...
  //--------------------------------------------------------------------------------
void ChannelStorage::get_key_orientation(size_t const& channel_index, size_t const& key_index, float& qs, float& qx,
                                         float& qy, float& qz) const
{
