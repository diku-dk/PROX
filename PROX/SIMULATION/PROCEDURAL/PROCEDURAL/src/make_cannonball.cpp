...
void make_cannonball(content::API* engine, typename MT::real_type const& radius,
                     ...
                     typename MT::vector3_type const& velocity, MaterialInfo<typename MT::real_type> mat_info)
...
template void make_cannonball<MTf>(content::API* engine, MTf::real_type const& radius,
                                   MTf::vector3_type const& position, MTf::quaternion_type const& orientation,
                                   MTf::vector3_type const& velocity, MaterialInfo<MTf::real_type> mat_info);
