                                    ...
                                    MaterialInfo<typename MT::real_type> mat_info)
{
    ...
    create_rigid_body(engine, T_b2w, Q_b2w, sphere_handle, mid, bottom_stone_density);
    ...
    create_rigid_body<MT>(engine, T_b2w, Q_b2w, sphere_handle, mid, top_stone_density);
}
