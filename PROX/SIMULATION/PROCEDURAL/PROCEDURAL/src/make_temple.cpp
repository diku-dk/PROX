    ...
    EigenVector3<T> vertices[8];
            ...
            for (size_t i = 0; i<gable_num_layers-1; ++i)
      {
        ...
        { /// tiles
            ...
            vertices[4] = vertices[0] - EigenVector3<T>(0, 0, 0.5f*(temple_depth -(floor(beam_spacing_ratio*num_pillars_z)-1)*spacing));
            vertices[5] = vertices[1] - EigenVector3<T>(0, 0, 0.5f*(temple_depth -(floor(beam_spacing_ratio*num_pillars_z)-1)*spacing));
            vertices[6] = vertices[2] - EigenVector3<T>(0, 0, 0.5f*(temple_depth -(floor(beam_spacing_ratio*num_pillars_z)-1)*spacing));
            vertices[7] = vertices[3] - EigenVector3<T>(0, 0, 0.5f*(temple_depth -(floor(beam_spacing_ratio*num_pillars_z)-1)*spacing));
