...
inline GeometryHandle<MT>
create_geometry_handle_mesh(content::API* engine, mesh_array::T3Mesh const& mesh,
...
template <typename T>
inline GeometryHandleEigen<T> create_geometry_handle_mesh(content::API* engine, mesh_array::T3Mesh const& mesh,
